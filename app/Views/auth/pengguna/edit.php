...
<div class="w-full py-5 mx-auto">
    ...
    <div class="p-4 bg-white shadow rounded-xl sm:p-7 dark:bg-slate-900">
        ...
        <form method="post" action="<?= site_url() ?>pengguna/<?= $user->IdUser ?>/update">
            <?= csrf_field(); ?>

            <div class="mb-4">
                <label for="Username" class="text-sm label">Username</label>
                <input id="Username" autofocus name="Username" type="text" class="input" value="<?= $user->Username ?>">
                <!-- Error -->
            ...
            <div class="mb-4">
                ...
                <input id="FullName" autofocus name="FullName" type="text" class="input" value="<?= $user->FullName ?>">
                <!-- Error -->
